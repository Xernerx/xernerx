...
const xernerxVersion = pkg.version;
export default {
    // Client
...
XernerxClient, 
// Enums
CommandType, EventEmitterType, InhibitorType, ContextCommandType, 
// Builds
EventBuilder, MessageCommandBuilder, ContextCommandBuilder, SlashCommandBuilder, InhibitorBuilder, ExtensionBuilder, XernerxError, 
// Constants
xernerxVersion, };
