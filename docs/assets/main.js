...
(() => {
	...
	var tt = (t, e, n, r) => {
		if ((e && typeof e == 'object') || typeof e == 'function') for (let i of Ze(e)) !Ye.call(t, i) && i !== n && he(t, i, { get: () => e[i], enumerable: !(r = Ge(e, i)) || r.enumerable });
		return t;
	};
...
`,
			...
			((t.Index = function (e) {
				...
				(t.Index.prototype.query = function (e) {
					for (
						var n = new t.Query(this.fields), r = Object.create(null), i = Object.create(null), s = Object.create(null), o = Object.create(null), a = Object.create(null), c = 0;
