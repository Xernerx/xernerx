...
(() => {
	...
	var De = (t, e, n, r) => {
		if ((e && typeof e == 'object') || typeof e == 'function') for (let i of _e(e)) !Me.call(t, i) && i !== n && ie(t, i, { get: () => e[i], enumerable: !(r = Oe(e, i)) || r.enumerable });
		return t;
	};
...
`,
			...
			(t.Builder = function () {
				...
				(function (e, n) {
					typeof define == 'function' && define.amd ? define(n) : typeof ae == 'object' ? (le.exports = n()) : (e.lunr = n());
				})(this, function () {
					return t;
				});
		})();
	...
	function He(t, e, n, r) {
		n.addEventListener(
			...
			n.addEventListener('keydown', (i) => {
				i.key == 'Enter' ? Be(e, t) : i.key == 'ArrowUp' ? (de(e, n, -1), i.preventDefault()) : i.key === 'ArrowDown' && (de(e, n, 1), i.preventDefault());
			}),
			...
			document.body.addEventListener('keyup', (i) => {
				t.classList.contains('has-focus') && (i.key === 'Escape' || (!e.matches(':focus-within') && !n.matches(':focus'))) && (n.blur(), te(t));
			});
	}
	function te(t) {
	...
	function he(t, e) {
		...
		let n = t.toLocaleLowerCase(),
			...
			s = 0,
			o = n.indexOf(r);
		for (; o != -1; ) i.push(ee(t.substring(s, o)), `<b>${ee(t.substring(o, o + r.length))}</b>`), (s = o + r.length), (o = n.indexOf(r, s));
